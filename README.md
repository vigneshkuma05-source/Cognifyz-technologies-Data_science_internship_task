...
Hi, I'm **Vignesh L**, an undergraduate student in **Bachelor of Computer Application** at **Seshadripuram  College**, graduating in **July 2026**.
...
### 🌐 Let's Connect!
- 🔗 **LinkedIn**: [www.linkedin.com/in/vignesh-l-151309370]
---
...
- **Techniques:** Data Cleaning, Model Building, Visualization  
...
```bash
git clone https://github.com/vigneshkuma05-source/Vignesh-L-source.git```

3. **Navigate to the Project Directory**

```bash
cd Cognifyz-Data-Science-Internship-Task
```
